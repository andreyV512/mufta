...
//	CSignal* iINMODULE; //МУФТА В МОДУЛЕ
//	CSignal* iZEROTRANSITION;	//ПЕРЕХОД ЧЕРЕЗ 0
	CSignal* iCC;	//Цепи управления
	CSignal* iPOW12;	//Питание +12В

	CSignal* oSENSORON;	//ВКЛ СИЛОВОЕ для замеров
	CSignal* oSENSLOWPOW;	//ВКЛ ПИТАНИЕ на все время работы
//	CSignal* oRESERV1;	//РЕЗЕРВ 1
	CSignal* oRESERV2;	//РЕЗЕРВ 2
	// Card0_OUT_Digital]
